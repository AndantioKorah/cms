  ...
  <div class="blog">
    <div class="sidebar">
      ...
      <a href="<?=base_url('news')?>"><h3 class="sidebar-title">Data Pojok TTG Lainnya</h3></a>
      <div class="sidebar-item recent-posts">
        <?php if($ttg){ foreach($ttg as $n){
        ...
        ?>
          <div class="post-item clearfix">
            ...
            <h4 class="judul-berita-other"><a href="<?=base_url('ttg/detail/'.$n['id'])?>"><?=$n['judul']?></a></h4>

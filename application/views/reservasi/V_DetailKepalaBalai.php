  ...
  <?php if($result){ ?>
    ...
    <script>
      ...
      $('#btn_verif').on('click', function(){
        ...
        $('#btn_loading').show()
        $.ajax({
          url: '<?=base_url('reservasi/C_Reservasi/verifKepalaBalai/')?>'+'<?=$result['id']?>',
          method: 'POST',
          data: null,
      ...
      $('#btn_batal_verif').on('click', function(){
        ...
        $('#btn_loading').show()
        $.ajax({
          url: '<?=base_url('reservasi/C_Reservasi/deleteVerifKepalaBalai/')?>'+'<?=$result['id']?>',
          method: 'POST',
          data: null,
          success: function(res){
            $('#btn_verif').show()
      ...
      function loadDetailLayanan(){
        ...
        $('#div_detail_layanan').load('<?=base_url('reservasi/C_Reservasi/loadDetailLayananKepalaBalai/'.$result['id'])?>', function(){
          $('#loader').hide()
        })
      }

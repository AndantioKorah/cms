...
<aside class="main-sidebar elevation-4 sidebar-light-navy">
  <!-- Brand Logo -->
  <a href="<?=base_url('admin/welcome')?>" class="brand-link navbar-navy">
    <img src="<?=base_url('assets/new_login/images/logo-white-navy-without-text.png')?>" alt="<?=TITLE_THIRD?>" class="brand-image img-circle elevation-3"
          style="opacity: .8">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a style="font-weight: bold !important;" href="<?=base_url('admin/user/setting')?>" class="d-block"><?=$this->general_library->getNamaUser();?></a>
      </div>
    </div>
    <?php 

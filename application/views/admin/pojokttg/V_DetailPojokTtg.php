...
<form id="" action="<?=base_url("admin/C_Admin/updateKontenPojokTtg")?>" class="form-horizontal" method="post" enctype="multipart/form-data" role="form">
                     ...
                     <label class="col-lg-6 col-sm-6 control-label">Gambar</label>
                        ...
                        <div class="container">
                        <?php   
                            $image = json_decode($pojokttg['gambar']);
                            $ng = 1;
                            foreach($image as $image_name)
                                {
                                        if($ng==1){
                                            echo "<div style='display: inline-block;'><img style='width:800;height:500px;' src=".base_url('assets/admin/pojokttg/'.$image_name.'')." style='width:100%'></div>";
                                        } else {
                                            echo "<div ><img style='width:800;height:500px;' src=".base_url('assets/admin/pojokttg/'.$image_name.'')." style='width:100%'></div>";
                                        }
                                   $ng++;
                                } 
                            ?>

...
<form id="" action="<?=base_url("admin/C_Admin/updateKontenAgenda")?>" class="form-horizontal" method="post" enctype="multipart/form-data" role="form">
                     <div class="form-group">
                         <label class="col-lg-6 col-sm-6 control-label">Judul </label>
                         <div class="col-lg-12">
                         <input type="hidden"  class="form-control" id="id" name="id" value="<?=$agenda['id']?>">
                             <textarea  class="form-control" id="detail_judul_agenda" name="detail_judul_agenda" ><?=$agenda['judul']?></textarea>
                         </div>
                     </div>
                     ...
                     <label class="col-lg-6 col-sm-6 control-label">Tanggal </label>
                         <div class="col-lg-12">
                             <input  class="form-control" id="detail_tanggal_agenda" name="detail_tanggal_agenda" value="<?=$agenda['tanggal']?>">
                         </div>
                     </div>
                     ...
                     <label class="col-lg-6 col-sm-6 control-label">Gambar</label>
                        ...
                        <div class="container">
                        <?php   
                            $image = json_decode($agenda['gambar']);
                            $ng = 1;
                            foreach($image as $image_name)
                                {
                                        if($ng==1){
                                            echo "<div style='display: inline-block;'><img style='width:800;height:500px;' src=".base_url('assets/admin/agenda/'.$image_name.'')." style='width:100%'></div>";
                                        } else {
                                            echo "<div ><img style='width:800;height:500px;' src=".base_url('assets/admin/agenda/'.$image_name.'')." style='width:100%'></div>";
                                        }
                                   $ng++;
                                } 
                            ?>
                        ...
                        <div class="form-group">
                         ...
                         <div class="col-lg-12">
                          <textarea rows="10" class="form-control " id="detail_isi_agenda" name="detail_isi_agenda" ><?=$agenda['isi_agenda']?></textarea>
                         </div>
                     </div>
...
// CKEDITOR.replace( 'detail_isi_berita' );
  ...
  var editorText = CKEDITOR.instances.detail_isi_berita.getData();
      ...
      e.preventDefault();  
           $.ajax({  
               url:"<?=base_url("admin/C_Admin/updateKontenPojokTtg")?>",  
...
ClassicEditor
		.create( document.querySelector( '#detail_isi_agenda' ), {
